package com.example.tellep_john_hw4;
...
public class MainActivity extends AppCompatActivity
{
    ...
    private View.OnClickListener onSaveButtonClick = new View.OnClickListener()
    {
        ...
        {
            SharedPreferences sharedpreferences = getSharedPreferences("ConnorsPreferences", Context.MODE_PRIVATE);
            String name = "";
            String email = "";
            String password = "";
    ...
    private View.OnClickListener onRetrieveButtonClick = new View.OnClickListener()
    {
        public void onClick(View view)
        {
            SharedPreferences sharedpreferences = getSharedPreferences("ConnorsPreferences", Context.MODE_PRIVATE);
    ...
    private View.OnClickListener onClearButtonClick = new View.OnClickListener()
    {
        public void onClick(View view)
        {
            name_input.setText("");
